...
//
// Title: Assignment Planner: Driver class implementation
  ...
  MAIN_MENU {
    ...
    public AssignmentPlannerState runState(Scanner scanner, AssignmentQueue queue) {
      ...
      if (num == 1) {
        ...
        if (queue.isEmpty()) {
          System.out.println("There are currently no assignments in the queue.");
        } else {
        ...
        if (queue.isEmpty()) {
          ...
          System.out.println("Highest priority assignment\n" + queue.dequeue() 
                                  + "\nhas been completed.");
        }
